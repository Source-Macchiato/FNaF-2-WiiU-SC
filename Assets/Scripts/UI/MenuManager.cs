...
public class MenuManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (currentScrollRect == null && currentPopup == null && currentButton != null && currentButton.GetComponent<SwitcherData>() == null && currentButton.GetComponent<CardSwitcher>() == null)
            {
